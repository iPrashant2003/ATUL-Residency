...
import { Bell, Check, MailOpen, AlertCircle, Info, CheckCircle2 } from "lucide-react";
...
export default function TenantNotificationsPage() {
  ...
  return (
    <AppLayout role="TENANT" title="My Notifications" subtitle="View all rent dues, receipts, and request updates">
      <div style={{ maxWidth: "800px", margin: "0 auto" }}>
        ...
        {loading ? (
          ...
          <div className="glass-card" style={{ padding: "60px", textAlign: "center" }}>
            ...
            <h3 style={{ fontWeight: 600, marginBottom: "6px" }}>No notifications yet</h3>
            <p style={{ color: "rgba(226,232,240,0.4)", fontSize: "13px" }}>Rent invoices and service updates will appear here.</p>
          </div>
        ) : (
          <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
            {notifications.map((n) => {
              const Icon = n.type === "RENT_DUE" || n.type === "RENT_OVERDUE" ? AlertCircle : n.type === "PAYMENT_APPROVED" ? CheckCircle2 : Info;
              const iconColor = n.type === "RENT_DUE" || n.type === "RENT_OVERDUE" ? "#ef4444" : n.type === "PAYMENT_APPROVED" ? "#10b981" : "#3b82f6";
